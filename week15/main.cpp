...
#define DEMO_METHOD 1       //主函数功能选择标志
#define YOLOV3_VIDEO ".\\DeepNeuralNetwork\\openposeTest.mp4"      //yolov 摄像头或视频路径
#define OPENPOSE_VIDEO ".\\DeepNeuralNetwork\\openposeTest.mp4"    //openpose 摄像头或视频路径
...
int yoloV3()
{
	...
	//coco数据集的名称文件，80类
	string classesFile= ".\\DeepNeuralNetwork\\coco.names";
	//yolov3网络模型文件
	String yolov3_model = ".\\DeepNeuralNetwork\\yolov3.cfg";
	//权重
	String weights = ".\\DeepNeuralNetwork\\yolov3.weights";
...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = ".\\DeepNeuralNetwork\\openpose_pose_coco.prototxt";
	String modelBin = ".\\DeepNeuralNetwork\\pose_iter_440000.caffemodel";
